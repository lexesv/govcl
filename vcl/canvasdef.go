...
func (c *TCanvas) Draw1(x, y int32, graphic IObject) {
...
func (c *TCanvas) TextRect1(aRect *TRect, text *string, textFormat TTextFormat) {
    Canvas_TextRect1(c.instance, aRect, text, textFormat)
}

func (c *TCanvas) TextRect2(aRect TRect, x, y int32, text string) {
    Canvas_TextRect2(c.instance, aRect, x, y, text)
}