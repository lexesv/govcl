...
*/
func SkinH_AttachEx(strSkin, strPwd string) int32 {
...
*/
func SkinH_AttachExt(strSkin, strPwd string, nHue, nSat, nBri int32) int32 {
...
*/
func SkinH_AttachRes(pSh uint8, nSize int32, strPwd string, nHue, nSat, nBri int32) int32 {
...
*/
func SkinH_DetachEx(hWnd types.HWND) int32 {
...
*/
func SkinH_SetWindowAlpha(hWnd types.HWND, nAlpha int32) int32 {
...
*/
func SkinH_SetMenuAlpha(nAlpha int32) int32 {
...
*/
func SkinH_GetColor(hWnd types.HWND, nPosX, nPosY int32) uint32 {
...
*/
func SkinH_AdjustHSV(nHue, nSat, nBri int32) int32 {
...
*/
func SkinH_Map(hWnd types.HWND, nType int32) int32 {
...
*/
func SkinH_LockUpdate(hWnd types.HWND, nLocked int32) int32 {
...
*/
func SkinH_SetAero(hWnd types.HWND) int32 {
...
*/
func SkinH_SetBackColor(hWnd types.HWND, nRed, nGreen, nBlue int32) int32 {
...
*/
func SkinH_SetForeColor(hWnd types.HWND, nRed, nGreen, nBlue int32) int32 {
...
*/
func SkinH_SetWindowMovable(hWnd types.HWND, bMove bool) int32 {
...
*/
func SkinH_AdjustAero(nAlpha, nShwDark, nShwSharp, nShwSize, nX, nY, nRed, nGreen, nBlue int32) int32 {
...
func SkinH_AdjustAeroDefaultAll() int32 {
	return SkinH_AdjustAero(0, 0, 0, 2, 0, 0, -1, -1, -1)
}
...
*/
func SkinH_NineBlt(hDtDC types.HDC, left, top, right, bottom, nMRect int32) int32 {
